...
const landlordAttrs = ["email", "family_name", "name"]

export function signUpUser({name, familyName, email, password}){
    ...
    const attributeName = new CognitoUserAttribute(dataName);
		...
		attributeList.push(attributeEmail, attributeFamilyName, attributeName);
